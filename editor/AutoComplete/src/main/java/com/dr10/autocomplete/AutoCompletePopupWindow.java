...
class AutoCompletePopupWindow extends JWindow implements CaretListener,
	...
	AutoCompletePopupWindow(Window parent, final AutoCompletion ac) {
		...
		list.setBackground(new ThemeApp.AwtColors().getSecondaryColor());
		...
		sp.setBorder(new EmptyBorder(5, 5, 5, 0));

		sp.getVerticalScrollBar().setUI(new CustomScrollBar(
				new ThemeApp.AwtColors().getSecondaryColor(),
				new ThemeApp.AwtColors().getComplementaryColor()
		));

		sp.getHorizontalScrollBar().setUI(new CustomScrollBar(
				new ThemeApp.AwtColors().getSecondaryColor(),
				new ThemeApp.AwtColors().getComplementaryColor()
		));
