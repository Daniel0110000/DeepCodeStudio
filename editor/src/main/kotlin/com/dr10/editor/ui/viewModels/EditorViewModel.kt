...
class EditorViewModel(
    ...
    private val _selectedOption: MutableLiveData<AutocompleteOptionModel> = MutableLiveData(
    ...
    fun selectedOption(
        ...
        scope.launch {
            autocompleteRepository.addSelectedAutocompleteOption(
                AutocompleteSelectionHistoryModel(
                    uuid = model.uuid,
    ...
    fun getAllAutocompleteOptions(){
        _allAutocompleteOptions.value = autocompleteRepository.getAllAutocompleteOptionsAsList()
    }
