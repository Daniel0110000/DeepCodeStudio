...
/**
 * Function to display the terminal emulator
 *
 * @param currentPath The current path where the terminal is initialized
 * @param onCloseTerminal Callback function to be executed when the terminal is closed
 */
