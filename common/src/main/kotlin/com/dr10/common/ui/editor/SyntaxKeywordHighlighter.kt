...
object SyntaxKeywordHighlighter {
    ...
    /**
     * Generates an annotated string applying syntax highlighting styles based on the provided [SyntaxHighlightOptionModel]
     *
     * @param str The input string to be highlighted
     * @param colors The [SyntaxHighlightOptionModel] containing color information for different syntax elements
    ...
    fun codeString(
        str: String,
        colors: SyntaxHighlightOptionModel,
